...
public class HBaseClusterManager extends Configured implements ClusterManager {
  ...
  private void exec(String hostname, ServiceType service, CommandProvider.Operation op) throws IOException {
