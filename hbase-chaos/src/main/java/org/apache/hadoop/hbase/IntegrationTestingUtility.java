...
public class IntegrationTestingUtility extends HBaseTestingUtility {
  ...
  private static final Class<? extends org.apache.hadoop.hbase.ClusterManager> DEFAULT_HBASE_CLUSTER_MANAGER_CLASS =
    org.apache.hadoop.hbase.HBaseClusterManager.class;
  ...
  public void createDistributedHBaseCluster() throws IOException {
    ...
    Class<? extends org.apache.hadoop.hbase.ClusterManager> clusterManagerClass = conf.getClass(HBASE_CLUSTER_MANAGER_CLASS,
      DEFAULT_HBASE_CLUSTER_MANAGER_CLASS, org.apache.hadoop.hbase.ClusterManager.class);
    org.apache.hadoop.hbase.ClusterManager clusterManager = ReflectionUtils.newInstance(
      clusterManagerClass, conf);
    setHBaseCluster(new org.apache.hadoop.hbase.DistributedHBaseCluster(conf, clusterManager));
    getAdmin();
  }
